...
var app = require('../')('app');
var servicename = 'DelegateService';
        ...
        describe(servicename, function() {
            ...
            describe('$getByHandle', function() {
                ...
                it('should get the only active instance from multiple instances with the same handle', function() {
                    ...
                    delegate._registerInstance(instance3, 'myhandle', function() {
                        return false;
                    });
                ...
                it('should get active instance when multiple sname name handles, among multiple active instances', function() {
                    delegate._registerInstance(instance1, 'myhandle-1', function() {
                        return true;
                    });
                    delegate._registerInstance(instance2, 'myhandle-2', function() {
                        return false;
                    });
                    delegate._registerInstance(instance3, 'myhandle-2', function() {
                        return true;
                    });
